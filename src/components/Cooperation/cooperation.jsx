...
const Cooperation = () => {
    return (
        <div className={scss.wrapper}>
            ...
            <p className={scss.dsc}>Maksymalnie angażujemy się w każdy projekt, dostarczając naszym klientom fachowe, merytoryczne wsparcie. Jednak tym, co nami kieruje i co wysuwa się na pierwszy plan są Twoje potrzeby, oczekiwania oraz budżet.
